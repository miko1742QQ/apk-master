...
<div class="card shadow">
    <div class="row card-header p-2 m-0">
        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6">
            <h4 class="py-2 mt-2">Daftar Pendik</h4>
        </div>

        <div class="col-lg-6 col-xl-6 col-md-6 col-xs-6 col-sm-6 col-6" align="right">
            <a href="../create_pendik" class="btn btn-outline-primary btn-sm btn-icon-split mt-2">
                <span class="icon"><i class="fas fa-plus"></i></span>
                <span class="p-1">Add Pendik</span>
            </a>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="./../Libraries/<?= base_url('template_pendik.xlsx') ?>" download=""><i class="fas fa-download"></i> Download Template</a></li>
                </ul>
            </div>

            <a href="./export_pendik" class="btn btn-outline-danger btn-sm btn-icon-split mt-2">
    ...
    <div class="card-body">
        <div class="table-responsive margin-tb">
            <table class="table table-hover display nowrap w-100" id="datatabel" cellspacing="0">
                <thead>
                    <tr class="first even" style="text-shadow: none; cursor: pointer;">
                        ...
                        <th style="text-align: center; vertical-align: middle; margin: 5px; padding: 7px;" rowspan="2">NAMA PENDIK</th>
                ...
                <tbody>
                    ...
                    <?php foreach ($pendik as $value) : ?>
                        ...
                        <tr style="vertical-align: middle; text-align: center; text-shadow: none;">
                            ...
                            <td style="margin: 5px; padding: 3px; text-align: justify;"><?= strtoupper($value["nama_pendik"]); ?></td>
                            ...
                            <td style="margin: 5px; padding: 3px; text-align: center;">
                                <?php if (user()->username == 'administrator') : ?>
                                    <a href="<?= base_url('edit_pendik/' . $value['id']) ?>" class="btn btn-outline-warning btn-sm btn-icon-split" style="width: 100px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
                                        <span class='icon'><i class='fas fa-edit'></i></span>
                                        <span class="p-1">Edit</span>
                                    </a>

                                    <a href="#" class="btn btn-outline-primary btn-sm btn-icon-split statusptk-button" style="width: 100px;" data-bs-toggle="modal" data-bs-target="#mutasiModal" data-id="<?= $value['id']; ?>" data-name="<?= $value['nama_pendik']; ?>" data-nameSekolahAsal="<?= $value['nama_sekolah']; ?>">
                                        <span class='icon'><i class='fas fa-exchange-alt'></i></span>
                                        <span class="p-1">Mutasi</span>
                                    </a>

                                    <?php if ($value['status'] == 'aktif') : ?>
                                        <a href="#" class="btn btn-outline-danger btn-sm btn-icon-split statusptk-button" style="width: 100px;" data-bs-toggle="modal" data-bs-target="#statusModal" data-id="<?= $value['id']; ?>" data-nameptk="<?= $value['nama_pendik']; ?>" data-nameSekolahAsalPTK="<?= $value['nama_sekolah']; ?>">
                                            <span class='icon'><i class='fas fa-ban'></i></span>
                                            <span class="p-1">Non-Aktif</span>
                                        </a>
                                    <?php else : ?>
                                        <a href="#" class="btn btn-outline-success btn-sm btn-icon-split statusptk-button" style="width: 100px;" data-bs-toggle="modal" data-bs-target="#statusModal" data-id="<?= $value['id']; ?>" data-nameptk="<?= $value['nama_pendik']; ?>" data-nameSekolahAsalPTK="<?= $value['nama_sekolah']; ?>">
                                            <span class='icon'><i class='fas fa-ban'></i></span>
                    ...
                    <form id="mutasiForm" action="<?= base_url('mutasi_process'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mutasiModalLabel">Mutasi <span id="namaPendik"></span></h5>
            ...
            <div class="modal fade" id="importModal" aria-labelledby="importModalLabel" aria-hidden="false" data-bs-backdrop="static" data-bs-keyboard="false">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
