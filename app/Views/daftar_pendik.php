                ...
                <tbody>
                    ...
                    <?php foreach ($pendik as $value) : ?>
                        ...
                        <tr style="vertical-align: middle; text-align: center; text-shadow: none;">
                            ...
                            <td style="margin: 5px; padding: 3px; text-align: center;"><?= $value["nama_pendik"]; ?></td>
                            ...
                            <td style="margin: 5px; padding: 3px; text-align: center;">
                                <a href="<?= base_url('edit_pendik/' . $value['id']) ?>" class="btn btn-outline-warning btn-sm btn-icon-split" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit">
